...
class top_block(gr.top_block, Qt.QWidget):
    ...
    #    self.gui_update_btn = gui_update_btn
        #self.set_samp_rate(self.get_gui_samp_rate()) set sampe rate
        #self.set_directory(self.get_gui_directory()) set directory
        #self.set_time_switch(self.get_gui_time_switch()) set switch time
